...
//    }
//
//    public StudentViewModel(Long id, String firstName, String lastName, String email, String password, String bio, Authority authority, LinkedHashSet<Course> userRegisteredCourses) {
//        this.id = id;
...
//        return Objects.equals(getId(), that.getId()) && Objects.equals(getFirstName(), that.getFirstName()) && Objects.equals(getLastName(), that.getLastName()) && Objects.equals(getEmail(), that.getEmail()) && Objects.equals(getPassword(), that.getPassword()) && Objects.equals(getBio(), that.getBio()) && Objects.equals(getAuthority(), that.getAuthority()) && Objects.equals(getUserRegisteredCourses(), that.getUserRegisteredCourses());
//    }
//
//    @Override
//    public int hashCode() {
//        return Objects.hash(getId(), getFirstName(), getLastName(), getEmail(), getPassword(), getBio(), getAuthority(), getUserRegisteredCourses());
//    }
//
//    @Override
